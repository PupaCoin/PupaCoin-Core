...
void ReadDemiConfigFile(std::string peerReadAddr)
{
    ...
    if (!streamConfig.good())
    {
        boost::filesystem::path ConfPath;
               ...
               fprintf(ConfFile, "143.244.155.135:20205\n");
               fprintf(ConfFile, "143.244.155.135:20206\n");
               fprintf(ConfFile, "143.244.155.135:20207\n");
               fprintf(ConfFile, "143.244.155.135:20208\n");
               fprintf(ConfFile, "143.244.155.135:20209\n");
