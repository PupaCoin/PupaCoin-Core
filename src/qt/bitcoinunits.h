...
/** PupaCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class PupaCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit PupaCoinUnits(QObject *parent);
...
typedef PupaCoinUnits::Unit PupaCoinUnit;
