...
class QCP_LIB_DECL QCPAxis : public QCPLayerable
{
  ...
  Q_PROPERTY(bool rangePupaCoinersed READ rangePupaCoinersed WRITE setRangePupaCoinersed)
...
public:
  ...
  */
  ...
  bool rangePupaCoinersed() const { return mRangePupaCoinersed; }
  ...
  void setRangePupaCoinersed(bool reversed);
