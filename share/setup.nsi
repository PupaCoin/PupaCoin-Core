...
Section -post SEC0001
    ...
    #    WriteRegStr HKCR "bitcoin" "" "URL:PupaCoin"
    #    WriteRegStr HKCR "bitcoin\DefaultIcon" "" $INSTDIR\bitcoin-qt.exe
    #    WriteRegStr HKCR "bitcoin\PupaCoin\open\command" "" '"$INSTDIR\bitcoin-qt.exe" "$$1"'
SectionEnd
...
Section -un.post UNSEC0001
    ...
    #Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\PupaCoin.lnk"
    #Delete /REBOOTOK "$SMSTARTUP\PupaCoin.lnk"
